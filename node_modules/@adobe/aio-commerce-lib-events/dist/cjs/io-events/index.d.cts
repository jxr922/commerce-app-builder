...
//#region source/io-events/api/event-ingress/endpoints.d.ts
/** Parameters required to publish an event to the I/O Events ingress. */
type PublishEventParams<TPayload extends Record<string, unknown> = Record<string, unknown>> = {
  /** The I/O Events provider UUID. */providerId: string; /** The fully-qualified event code. */
  eventCode: string; /** The event payload. Must be a JSON object. */
  payload: TPayload;
  /**
 ...
 */
declare function publishEvent<TPayload extends Record<string, unknown> = Record<string, unknown>>(httpClient: AdobeIoEventsHttpClient, params: PublishEventParams<TPayload>): Promise<void>;
//#endregion
...
declare function createAdobeIoEventsApiClient(params: IoEventsHttpClientParams): import("@adobe/aio-commerce-lib-api").ApiClientRecord<AdobeIoEventsHttpClient, {
  publishEvent<TPayload extends Record<string, unknown> = Record<string, unknown>>(httpClient: AdobeIoEventsHttpClient, params: PublishEventParams<TPayload>): Promise<void>;
