...
const require_index_node = require('../index.node-BDMqlp90.cjs');
const require_define = require('../define-C-Xq1pCa.cjs');
...
exports.hasAdminUi = require_webhooks.hasAdminUi;
...
exports.isTypeScriptConfig = require_index_node.isTypeScriptConfig;
exports.parseCommerceAppConfig = require_index_node.parseCommerceAppConfig;
exports.readCommerceAppConfig = require_index_node.readCommerceAppConfig;
exports.resolveCommerceAppConfig = require_index_node.resolveCommerceAppConfig;
