...
_adobe_aio_lib_core_logging = require_rolldown_runtime.__toESM(_adobe_aio_lib_core_logging, 1);
...
function logger({ name, ...restOptions } = {}) {
	return (ctx) => {
		...
		return { logger: (0, _adobe_aio_lib_core_logging.default)(loggerName, {
