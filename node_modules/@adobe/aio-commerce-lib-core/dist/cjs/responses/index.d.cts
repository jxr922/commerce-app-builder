 ...
 * ```
 */
declare function isSuccessResponse(response: unknown): response is SuccessResponse;
/**
 ...
 * ```
 */
declare function isActionResponse(response: unknown): response is ActionResponse;
/**
 ...
 */
declare const ok: <TBody extends BodyRecord = BodyRecord>(payload?: string | {
  body?: TBody;
 ...
 * See {@link buildSuccessResponse} for details on the response payload.
 */
declare const created: <TBody extends BodyRecord = BodyRecord>(payload?: string | {
  body?: TBody;
  headers?: HeadersRecord;
}) => SuccessResponse<TBody>;
/**
 ...
 * See {@link buildSuccessResponse} for details on the response payload.
 */
declare const accepted: <TBody extends BodyRecord = BodyRecord>(payload?: string | {
  body?: TBody;
  headers?: HeadersRecord;
}) => SuccessResponse<TBody>;
/**
 ...
 * See {@link buildSuccessResponse} for details on the response payload.
 */
declare const nonAuthoritativeInformation: <TBody extends BodyRecord = BodyRecord>(payload?: string | {
  body?: TBody;
  headers?: HeadersRecord;
}) => SuccessResponse<TBody>;
/**
 ...
 */
declare const badRequest: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const unauthorized: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const forbidden: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const notFound: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const methodNotAllowed: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const conflict: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const internalServerError: <TBody extends BodyRecordWithMessage = BodyRecordWithMessage>(payload: string | {
  body: TBody;
  headers?: HeadersRecord;
}) => ErrorResponse<TBody>;
//#endregion
export { type ActionResponse, type ErrorResponse, HTTP_ACCEPTED, HTTP_BAD_REQUEST, HTTP_CONFLICT, HTTP_CREATED, HTTP_FORBIDDEN, HTTP_INTERNAL_SERVER_ERROR, HTTP_METHOD_NOT_ALLOWED, HTTP_NON_AUTHORITATIVE_INFORMATION, HTTP_NOT_FOUND, HTTP_NO_CONTENT, HTTP_OK, HTTP_UNAUTHORIZED, type SuccessResponse, accepted, badRequest, buildErrorResponse, buildSuccessResponse, conflict, created, forbidden, internalServerError, isActionResponse, isErrorResponse, isSuccessResponse, methodNotAllowed, noContent, nonAuthoritativeInformation, notFound, ok, unauthorized };