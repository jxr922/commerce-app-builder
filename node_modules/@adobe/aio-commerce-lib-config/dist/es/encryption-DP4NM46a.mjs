...
function decrypt(encryptedText, encryptionKey) {
	...
	try {
		...
		const decipher = createDecipheriv(ALGORITHM, Buffer.from(encryptionKey, "hex"), iv);
...
//#endregion
export { validateEncryptionKey as i, encrypt as n, generateEncryptionKey as r, decrypt as t };