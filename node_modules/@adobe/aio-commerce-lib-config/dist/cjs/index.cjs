...
const require_encryption = require('./encryption-DBGicl9b.cjs');
...
exports.getSystemConfigByKey = getSystemConfigByKey;
...
exports.setSystemConfigByKey = setSystemConfigByKey;
