...
_adobe_aio_lib_ims = require_rolldown_runtime.__toESM(_adobe_aio_lib_ims, 1);
let crypto = require("crypto");
crypto = require_rolldown_runtime.__toESM(crypto, 1);
let oauth_1_0a = require("oauth-1.0a");
oauth_1_0a = require_rolldown_runtime.__toESM(oauth_1_0a, 1);
...
function getIntegrationAuthProvider(authParams) {
	...
	return { getHeaders: (method, url) => {
		const parsed = new URL((0, valibot.parse)(UrlSchema, url));
		const data = {};
