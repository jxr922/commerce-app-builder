export interface Button {
    ...
    /**
     * Optional string icon name (e.g. `'Settings'`, `'User'`, `'Bell'`) shown to
     * the left of the label. Resolved by the Shell against its icon set; unknown
     * names render no icon. Currently displayed in the Left Nav (headerless)
     * profile menu.
     */
    icon?: string;
    /**
