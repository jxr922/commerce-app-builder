...
export interface ObjectWithPath {
    ...
    collaborator?: string;
    /**
     * Optional instance id to be added to URL path.
     *
     * ***Example:***
     *
     * ```typescript
     * {path: '/abc', instance: 'id1234'}
     * ```
     */
    instance?: string;
    /**
...
export interface UrlContextUpdate {
     ...
     * Currently support only exists for collaborator and instance
     */
    contextKey: Omit<UrlContextKey, UrlContextKey.SANDBOX | UrlContextKey.SUBORG | UrlContextKey.INSTANCE>;
}
...
export interface PageDoneOptions {
    /**
     * Optional name for the page loaded. This can be used to identify different parts (routes) of the application
     * being loaded. It can also be used to track internal navigations within the same app.
     */
    name?: string;
}
export interface PageStartOptions {
    /**
     * Optional name for the page loaded. This needs to match the name used in the done call.
     * Keep empty if the name is not known yet.
     */
    name?: string;
    /**
     * Optional nested App ID. Set this right before nesting SPA inside another SPA.
     */
    nestedAppId?: string;
    /**
     * Optional nested SPA name. Set this right before nesting SPA inside another SPA.
     */
    nestedSpaName?: string;
    /**
     * Optional true to show the loading spinner.
     * page.start({spinner: true}) is equivalent to:
     * ```typescript
     *   page.start();
     *   page.spinner = true;
     * ```
...
export interface PageApi extends PageApiProperties {
    ...
    reloadSandbox(): void;
    /**
     * Tells the Shell that the Solution is starting load a new page.
     * @param options
     */
    start(options?: PageStartOptions): void;
    /**
