...
Object.defineProperty(exports, "getEMR", { enumerable: true, get: function () { return Global_1.getEMR; } });
...
function init(bootstrap) {
    const callback = () => {
        ...
        if (emr) {
            emr['exc-app-version'] = version_1.default;
        }
        bootstrap(runtime());
    };
    if ((0, Global_1.getEMR)()) {
        callback();
    }
    else {
...
function isNested() {
    var _a;
    return !!((_a = (0, Global_1.getEMR)()) === null || _a === void 0 ? void 0 : _a.isNested);
}
