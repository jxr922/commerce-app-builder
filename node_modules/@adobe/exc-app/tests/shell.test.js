...
describe('shell', () => {
    ...
    beforeEach(() => {
        ...
        jest.spyOn(emr, 'shell').mockReturnValue(shellMock);
    });
    it('can emit()', () => {
    ...
    it('can get()', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(spy).toHaveBeenCalledWith('environment');
        expect(spy).toHaveBeenCalledWith('imsEnvironment');
        expect(spy).toHaveBeenCalledWith('shellInfo');
    }));
