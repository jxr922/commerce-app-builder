...
describe('cache', () => {
    ...
    beforeAll(() => {
        ...
        jest.spyOn(emr, 'cache').mockReturnValue(cacheMock);
    });
    ...
    test('keys', () => __awaiter(void 0, void 0, void 0, function* () {
        yield cache_1.default.keys();
        expect(keysMock).toHaveBeenCalledTimes(1);
        expect(keysMock).toHaveBeenCalledWith({});
        yield cache_1.default.keys({ sharedCache: 'its-shared' });
        expect(keysMock).toHaveBeenCalledTimes(2);
        expect(keysMock).toHaveBeenCalledWith({ sharedCache: 'its-shared' });
    }));
});
