...
export interface QueryRequest {
    ...
    /**
     * Add a unique request UUID (x-request-id header), defaults to uuidv1.
     */
    requestId?: string;
    /**
    ...
    scope?: FetchScope;
    /**
     * Signal object to use to abort query
     */
    signal?: AbortSignal;
    /**
     * HTTP Status Codes which will prompt a retry. If not provided only network failures
...
export interface BaseNetworkConfig {
    ...
    gqlEndpoint?: string;
    /**
     * Preview header value from shell URL gql_preview param, propagated to nested SPAs.
     */
    gqlPreview?: string;
    /**
